								...
								<div class="col-md-4">
									<div class="form-group" style="z-index: 10;">
										...
										<select class="browser-default custom-select" name="course_code">
											...
											$query="select distinct(course_code) from teacher_courses ";
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<select class="browser-default custom-select" name="semester" required="">
											...
											<?php
											$teacher_id=$_SESSION['teacher_id'];
											// $query="select distinct(semester) from teacher_courses where teacher_id='$teacher_id'";
											$query="select distinct(semester) from teacher_courses";
											$run=mysqli_query($con,$query);
											while($row=mysqli_fetch_array($run)) {
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<select class="browser-default custom-select" name="subject_code" required="">
											...
											$query="select distinct(subject_code) from teacher_courses";
											$run=mysqli_query($con,$query);
											while($row=mysqli_fetch_array($run)) {
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						<section class="mt-3">
							<table class="table-elements mb-5 table-three-tr" cellpadding="5" >
								...
								$i=1;
								$count=0;
									$conn=mysqli_connect("localhost","root","","scsm_college");
