					...
					<div class="col-md-12">
						<section class="border mt-3">
							<table border="1" class="w-100 table-striped table-dark"cellpadding="5" >
								...
								$query="select tc.teacher_id,tc.course_code,tc.subject_code,tc.semester,tc.total_classes,tt.room_no,tt.timing_to from teacher_courses tc inner join time_table tt on tc.subject_code=tt.subject_code ";
