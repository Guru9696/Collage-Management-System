        ...
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link" href="../admin/Teacher.php">
              ...
              <i class="fa fa-user mr-2" aria-hidden="true"></i>Teacher 
            </a>
		      </li>
          <li class="nav-item">
            <a class="nav-link" href="../admin/Student.php">
              <span data-feather="shopping-cart"></span>
              <i class="fa fa-user-circle mr-2" aria-hidden="true"></i> Student 
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admin/student-attendance.php">
              <span data-feather="layers"></span>
              <i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Assignment
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admin/student-syllabus.php">
              <span data-feather="layers"></span>
              <i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Subject Syllabus
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admin/student-project.php">
              <span data-feather="layers"></span>
              <i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Project Report
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admin/student-attendance.php">
              <span data-feather="layers"></span>
              <i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Student Marks
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admin/student-attendance.php">
              <span data-feather="layers"></span>
              <i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Stud Attendance
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admin/addmision-check.php">
              <span data-feather="layers"></span>
              <i class="fa fa-key mr-2" aria-hidden="true"></i> New Addmision
            </a>
          </li>
          <li class="nav-item">
