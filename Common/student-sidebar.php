			...
			<div class="col-xl-2 col-lg-3 col-md-4 sidebar position-fixed border-right">
				...
				<ul class="nav flex-column">
					...
					<li class="nav-item">
						...
						<span data-feather="shopping-cart"></span>
						<i class="fa fa-th-list mr-2" aria-hidden="true"></i> Student Marksheet
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../student/student-subject.php">
						<span data-feather="shopping-cart"></span>
						<i class="fa fa-th-list mr-2" aria-hidden="true"></i> Student Subject
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../student/student-transcript.php">
						<span data-feather="shopping-cart"></span>
						<i class="fa fa-th-list mr-2" aria-hidden="true"></i> Subject Teacher
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../student/student-timetable.php">
						<span data-feather="shopping-cart"></span>
						<i class="fa fa-th-list mr-2" aria-hidden="true"></i> Student Time-Table
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../student/student-transcript.php">
						<span data-feather="shopping-cart"></span>
						<i class="fa fa-th-list mr-2" aria-hidden="true"></i> Subject Assignment
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../student/student-attendance.php">
						<span data-feather="shopping-cart"></span>
						<i class="fa fa-th-list mr-2" aria-hidden="true"></i> Student Attendance
						</a>
					</li>
					<li class="nav-item">
