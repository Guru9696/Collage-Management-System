			...
			<div class="sub-main">
									...
									<div class="modal-body">
										<form action="teacher.php" method="post" enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														...
														<input type="text" name="cnic" class="form-control" placeholder="Aadhar No">
													</div>
												</div>
											</div>
											<div class="row">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Last Qualification:</label>
														<input type="text" name="last_qualification" class="form-control" placeholder="Enter Place of Birth">
													</div>
												</div>
											</div>
											<div class="row">
				...
				<div class="row w-100">
					<div class="col-md-12 ml-2">
						<section class="mt-3">
							<div class="row">
								<div class="col-md-3 offset-9 pt-1 mb-2">
									<!-- Large modal -->
