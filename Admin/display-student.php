...
<?php  
	...
	if ($_SESSION["LoginAdmin"] && !$_SESSION['LoginStudent'])
	{
		...
		// $email=$_GET['email'] ?? $_SESSION['LoginStudent'];
...
<html lang="en">
	...
	while ($row=mysqli_fetch_array($run)) {
		...
		<div class="container  mt-1 border border-secondary mb-1">
			...
			<div class="row pt-3">
				<div class="col-md-4"><h5>Father No:</h5> <?php echo $row['other_phone']  ?></div>
			...
			<div class="row pt-3">
				...
				<div class="col-md-4"><h5>Class:</h5> <?php echo $row['session']  ?></div>
			</div>
			<div class="row pt-3">
			...
			<div class="row pt-3">
				...
				<div class="col-md-4"><h5>Matric Marks/CGPA:</h5> <?php echo $row['matric_awarded_date']  ?></div>
				<!-- <div class="col-md-4"><h5>Matric Certificate:</h5> <?php echo $row['matric_certificate']  ?></div> -->
				<div class="col-md-4"><h5>Matric Certificate:</h5> 
				<div class="col-md-4">
					<?php  $matric_certificate= $row["matric_certificate"] ?>
					<img class="ml-0 mb-2" height='190px' width='150px' src=<?php echo "images/$matric_certificate"  ?> >
				</div>
			...
			<div class="row pt-3">
				...
				<div class="col-md-4"><h5>HSC Marks/CGPA:</h5> <?php echo $row['fa_awarded_date']  ?></div>
				<!-- <div class="col-md-4"><h5>HSC Certificate:</h5> <?php echo $row['fa_certificate']  ?></div> -->
				<div class="col-md-4"><h5>HSC Certificate:</h5> 
					<div class="col-md-4">
						<?php  $fa_certificate= $row["fa_certificate"] ?>
						<img class="ml-0 mb-2" height='190px' width='150px' src=<?php echo "images/$fa_certificate"  ?> >
					</div>
				</div>
			</div>
			<!-- <div class="row pt-3">
