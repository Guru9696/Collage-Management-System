...
// *****************************************Images upload code end here********************************************************** 
		...
		$query="Insert into student_info(roll_no,first_name,middle_name,last_name,father_name,email,mobile_no,course_code,session,semester,profile_image,cnic,dob,gender,other_phone,permanent_address,current_address,place_of_birth,state,matric_complition_date,matric_awarded_date,matric_certificate,fa_complition_date,fa_awarded_date,fa_certificate)values('$roll_no','$first_name','$middle_name','$last_name','$father_name','$email','$mobile_no','$course_code','$session','$semester','$profile_image','$cnic','$dob','$gender','$other_phone','$permanent_address','$current_address','$place_of_birth','$state','$matric_complition_date','$matric_awarded_date','$matric_certificate','$fa_complition_date','$fa_awarded_date','$fa_certificate')";
							        ...
							        <form action="student.php" method="POST" enctype="multipart/form-data">
										<div class="row mt-3">
											...
											<div class="col-md-4">
												<div class="form-group">
												    ...
												    <select class="browser-default custom-select" name="semester" required>
													    ...
													    <?php
															$query="select semester_no from semester";
															$run=mysqli_query($con,$query);
															while($row=mysqli_fetch_array($run)) {
															 echo	"<option value=".$row['semester_no'].">".$row['semester_no']."</option>";
															}
														?>
													</select>
								  		...
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    ...
												    <input type="number" name="cnic" data-inputmask="'mask': '99999-9999999-9'" placeholder="XXXX-XXXX-XXXX" class="form-control">
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
								  		...
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Father No:*</label>
												    <input type="number" name="other_phone" class="form-control" required>
											    </div>
											</div>
								  		</div>
								  		<div class="row">
								...
								while($row=mysqli_fetch_array($run)) {?>
									<tr>
										...
										// $email=$_SESSION['LoginStudent'];
												...
												// echo "<a class='btn btn-primary' href=display-student.php?email=".$row['email'].">Profile</a> 
												// <a class='btn btn-danger' href=delete-function.php?email=".$row['email'].">Delete</a> "
										?>
										</td>
									</tr>
								<?php }
