...
<?php include "../common/common-header.php"?>
    <div class="container mt-4">
        <div class="text-danger text-center m-auto">
            <img src="../Images/maharaj.png" alt="" width="140" height="160">
            <h4 class="text-dark mt-3">Shri Chhatrpati Shivaji Mahavidyalaya</h4>
            <h4 class="text-dark">College Of Science, Art & Commerce </h4>
        </div>
    </div>
        ...
        <div class="program-info">
            <?php  
                ...
                while($row = mysqli_fetch_array($run)){ ?>
                    <h5>Student MArksheet - <?php echo $row['course_code']; ?> Program</h5>
        </div>
